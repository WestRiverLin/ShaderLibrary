...
Shader "SoFunny/linchunjie/Particles/Additive" {
Properties {
    _TintColor ("Tint Color", Color) = (0.5,0.5,0.5,0.5)
    _MainTex ("Particle Texture", 2D) = "white" {}
    _InvFade ("Soft Particles Factor", Range(0.01,3.0)) = 1.0
    _ClipRect ("Clip Rect", Vector) = (0.5,0.5,0.5,0.5)
    _UseClipRect("_UseClipRect",Float)=1
}
    ...
    SubShader {
        Pass {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float clip = UnityGet2DClipping(i.texcoord.zw, _ClipRect);
                if(clip<=0){
                ...
                col.a = lerp(col.a, clip * col.a, _UseClipRect);
